...
// extensions/lookup-providers/yandex/index.tsx
...
(function() {
  ...
  const performLookup = async (query) => {
    ...
    const res = await ResultAsync.fromPromise(axios.get("https://dictionary.yandex.net/api/v1/dicservice.json/lookup", {
      params: {
        key,
        lang: "de-en",
        text: query
    ...
    return ok(jsx_dev_runtime.jsxDEV(jsx_dev_runtime.Fragment, {
      children: data.def.map((def) => {
        if (!def.tr || def.tr.length === 0)
          return;
        const article = genderToArticleMapping[data.def[0].gen];
        const definitions = def.tr.map((tr) => tr.text);
        const info = def.fl;
        return jsx_dev_runtime.jsxDEV("div", {
          children: [
            ...
            jsx_dev_runtime.jsxDEV("ul", {
              children: definitions.map((definition) => jsx_dev_runtime.jsxDEV("li", {
                children: definition
              }, definition, false, undefined, this))
            }, undefined, false, undefined, this)
          ]
        }, def.text, true, undefined, this);
      }).filter(Boolean)
    }, undefined, false, undefined, this));
  };
  return {
