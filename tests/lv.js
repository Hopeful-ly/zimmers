...
// extensions/lookup-providers/lingva/index.tsx
...
(function() {
  ...
  const performLookup = async (query) => {
    const result = await ResultAsync.fromPromise(axios.get("https://lingva.lunar.icu/api/v1/de/en/" + query), () => new Error("Failed to fetch data"));
    if (result.isErr()) {
      return err(new Error("Failed to fetch data"));
    }
    const data = result.value.data;
    const translation = data.translation;
    return ok(jsx_dev_runtime.jsxDEV("p", {
